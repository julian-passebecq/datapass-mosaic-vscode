...
## 0a. BI-2: dbt in the BI Lab (Datapass dbt emulation) — Claude, 2026-09-25

Branch `feature/bi-dbt`, stacked on `feature/bi-lab` (§0b). The user asked to continue with BI-2 (dbt in the BI
...
## 0b. BI Lab: data warehousing, SQL lineage and star models — Claude, 2026-09-25

Branch `feature/bi-lab`, stacked on `content/databricks-v1` (§0c). A new Workbench module **BI Lab** (id `bi`), the
...
## 0c. Cloud Lab Databricks (jobs, compute, Unity Catalog, MLflow) — Claude, 2026-09-25

Branch `feature/databricks-lab`, stacked on `feature/sqlpool-lab` (§0d). A **Databricks** tab in Cloud Lab: a simulated
...
## 0d. Cloud Lab SQL pool (Synapse dedicated SQL pool, Fabric Warehouse) — Claude, 2026-09-25

Branch `feature/sqlpool-lab`, stacked on `content/cloud-pipelines-v1` (§0e). A **SQL pool** tab in Cloud Lab and the `sqlpool-v1` Practice pack.
...
## 0e. Cloud Lab pipeline exercises — Claude, 2026-09-25

Branch `content/cloud-pipelines-v1`, stacked on `feature/factory-lab` (§0f). Guided Practice exercises on the Cloud Lab pipeline simulator.
...
## 0f. Cloud Lab pipelines (Factory Lab) — Claude, 2026-09-25
...
## 0g. Airflow lab simulator and exercise pack — Claude, 2026-09-25
...
## 0h. Spark lab pack and simulated plan checks — Claude, 2026-09-25
...
## 0i. Data-engineering patterns pack — Claude, 2026-09-25
...
## 0j. Mosaic CSV import — Claude, 2026-09-25
...
## 0k. Polish tranche — Claude, 2026-09-25
...
## 0l. Manual F5 pass — Claude, 2026-09-25
...
## 0m. Content tranche — Claude, 2026-09-24
...
3. ~~A Mosaic "Import CSV into catalog" action~~ Done (§0j).
...
5. ~~`package-lock.json` is not committed~~ Done: the lockfile is committed and CI uses `npm ci` (§0k).
...
Later tranches added the work recorded in §0a; all of it is now on `main`.
