...
Not modeled: pools, concurrency limits, `max_active_runs`, cross-run dependencies, asset triggers, timezones other than UTC, DST, XCom values, executors and worker failures. Each run is simulated to completion with free worker slots.
