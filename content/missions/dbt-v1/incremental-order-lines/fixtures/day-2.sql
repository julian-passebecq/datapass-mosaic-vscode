-- 13 March: from now on the shop exports every order, but only the lines created or changed since the
-- previous export. The landing table is replaced, as every night.
-- SO1007 got a second line after it was paid (a harness added by phone); SO1008's discount was corrected.
...
FROM (VALUES
    ...
    ('SO1008', 'C003', '2026-03-11', 'store', 'card',   '2026-03-13 02:00:00'),
    ('SO1009', 'C006', '2026-03-12', 'web',   'card',   '2026-03-13 02:00:00'),
    ('SO1010', 'C009', '2026-03-12', 'web',   'card',   '2026-03-13 02:00:00'),
    ('SO1011', 'C002', '2026-03-12', 'store', 'card',   '2026-03-13 02:00:00')
...
FROM (VALUES
    ('SO1007', 2, 'P05', 1,  69.00,  0.00, '2026-03-13 02:00:00'),
    ('SO1008', 1, 'P01', 2, 199.00, 40.00, '2026-03-13 02:00:00'),
