...
export async function run(): Promise<void> {
  ...
  const hostSteps: Step[] = [
    ["extension activates and registers every Workbench command", async () => {
      ...
      for (const command of ["datapass.openHome", "datapass.runtime.action", "datapass.practice.submit", "datapass.missions.check", "datapass.catalog.refresh", "datapass.catalog.openScratch", "datapass.catalog.previewTable"]) {
